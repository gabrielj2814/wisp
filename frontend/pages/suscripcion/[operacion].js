        ...
        <>
            <section className='min-vh-100 modulo-plan-formulario pb-5'>
                ...
                <div className='d-flex mb-5 px-5'>
                    <Link href="/suscripcion" className="btn btn-primary">Regresar</Link>
                </div>
                <h1 className=' text-white text-center mb-2'>Formulario Suscripción</h1>
                ...
                <div className=' container-fluid'>
                    <form id="formularioSuscripcion" onSubmit={cancelarOnSubmit} className=' row justify-content-center'>
                        <div className='col-12 col-sm-12 col-md-12 col-lg-11 col-xl-11'>
                            ...
                            <div className=' row justify-content-center'>
                                <div className='mb-4 col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3'>
                                    <CampoSelectdNormalComponent opcionesSelect={[]} id="ip" name="ip" campoObligatorio="1" labelCampo="Ip" clasesStyleLabel="text-white" clasesStyle="form-control" />
                                </div>
                                <div className='mb-4 col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3 offset-10 offset-sm-10 offset-md-3 offset-lg-3 offset-xl-3 d-none d-md-flex'></div>
                            </div>
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="formulario del modulo suscripcion" />
