        ...
        <nav id="contenedorMenu" className="contenedor-menu">
            ...
            <div className="menu-movil d-block d-lg-none">
                <div className="contenedor-icon-menu">
                    <svg onClick={mostrarMenuMovil} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-menu"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
                </div>
                <section id="contenedorItemsMovil" className="contenedor-items-movil">
                    <div className="items-movil p-4">
                        <svg onClick={mostrarMenuMovil} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-x icon-x mb-4"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
